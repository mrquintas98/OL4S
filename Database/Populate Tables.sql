...
insert into table userstatistics (userstatistics_date,userstatistics_session,userstatistics_duration,userstatistics_fishes,userstatistics_birds,userstatistics_animals,userstatistics_timezones,userstatistics_user_id) values
(str_to_date('20.10.2020','%d.%m.%Y'),1,94,1,2,4,1,3),
(str_to_date('21.10.2020','%d.%m.%Y'),2,54,3,5,10,1,3),
(str_to_date('29.10.2020','%d.%m.%Y'),3,81,5,7,17,1,3);
...
insert into table ut ( ut_userreq_id,ut_userval_id,ut_ticket_id) values
(3,2,1);


insert into table ticket ( ticket_descrition,ticket_name,ticket_scientificname,ticket_latitude,ticket_longitude,ticket_ticketstatus_id) values
('Peixe encontrado no Cais do Gás. Pesca água doce.','Corvina','Argyrosomus regius',38.704844,-9.147001,1) ;

insert into table ticketstatus (ticketstatuts_status) values
('Pending'),
('Denied'),
('Approved');

insert into table tis (tis_ticket_id,tis_infospecifics_id) values
(1,3),
(1,8);

insert into table infospecifics (infospecifics_name) values
('animal'),
('bird'),
('fish'),
('store'),
...
insert into table tia (tia_ticket_id,tia_infoactivity_id) values
(1,1);

insert into table infoactivity (infoactivity_name) values
('fishing'),
('farming'),
('hunting'),
('camping'),
...
insert into table info (info_latitude,info_longitude,info_description,info_name,info_scientificname) values
...
insert into table iia (iia_info_id,iia_infoactivity_id) values
(1,1);

insert into table iis (iis_info_id,iis_infospecifics_id) values
(1,3),
(1,8);
